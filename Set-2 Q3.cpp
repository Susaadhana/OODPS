...
The SmartCar class must access both modules together to provide a complete smart-driving experience.
 Design a C++ program to combine both independent functionalities.*/
#include <iostream>
using namespace std;
